...
coloniesnames = {"Bob", "Frank", "John", "David", "Mark", "Carl", "Russell", "Neil", "Amy", "Chris", "Aimiee", "Sarah",
                 "Kent", "Barry", "Scott", "Christine", "Jenny", "Josh", "Alien", "Scotty", "Fred", "Garry", "Erik",
                 "Harry", "Jean", "Harry", "Abby", "Alfred", "Amy", "Andy", "Abe", "Bart", "Bryan", "Bryce", "Alice",
                 "Ashley", "Gordon", "Mafiatoss", "Cake", "Jean", "Pipe", "Cupcake", "Mr Troll", "Kerrigan", "Jim",
                 "Raynor", "Douglas", "Adams", "Link", "Zelda", "Arthas", "Sharlock", "Homes", "Simpson", "Homer",
                 "Edisier", "Christophe", "Eric", "Hugo", "Victor", "Renner", "Denoel", "Poivre", "Sel", "Saarlouis",
                 "RitzenHoff", "Terraria", "Seb", "Pipi", "Caca", "Hint", "Bill"}
...
CreateConVar("rc_spreadthelove", 0, {FCVAR_NOTIFY})
...
CreateConVar("rc_veryhungry", 80, {FCVAR_NOTIFY}) -- the % of maxhunger after which npcs of same class can eat each others (It doesn't affect human.)
...
hook.Add("Initialize", "ColonyTags", function()
...
hook.Add("OnNPCKilled", "ColonyKilledNPC", function(v, k, w)
    ...
    if k:GetClass():sub(1, 12) == "npc_headcrab" and k:GetNWBool("HC") and Ok == 1 and
        GetConVarNumber("rc_headcrab_tozombie") == 1 then
...
hook.Add("PlayerInitialSpawn", "ColoniesDefaultPlayerFaction", function(ply, sid)
    ply:SetPData("HCfaction", "Default Faction")
end)
